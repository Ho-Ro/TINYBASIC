...
;
;Ho-Ro 2024-10-25:
;Source code taken from http://cpuville.com/Code/Tiny-BASIC.html
;Changed ORG statements at end of file to match this HW:
;2K ROM at 0000H, 2K RAM at 0800H
RAMBGN:         .EQU    0800H
RAMSZE:         .EQU    0800H
;6850 ACIA for serial IO: DATA at 01H, STATUS at 02H
;Replaced "magic numbers" in source code by "speaking constants" defined here
; IO MAP FOR 6850 ACIA
IODATA:         .EQU    1               ;RECEIVE / TRANSMIT DATA REGISTER
IOSTAT:         .EQU    2               ;STATUS / CONTROL REGISTER
; 6850 STATUS REGISTER BITS
IORDRF:         .EQU    0               ;RECEIVE DATA REGISTER FULL
IOTDRE:         .EQU    1               ;TRANSMIT DATA REGISTER EMPTY
;Assembler: zmac (https://github.com/gp48k/zmac)
;Original source code (with my changes) starts below
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
OC3:    IN   IOSTAT                     ;Ch status
        ANI  1 << IOTDRE                ;STATUS BIT
...
TXTBGN: DS   2                          ;TEXT SAVE AREA BEGINS
        ...
        ORG  RAMBGN+RAMSZE-100H		;
TXTEND: EQU  $                          ;TEXT SAVE AREA ENDS
VARBGN: DS   2                          ;VARIABLE @(0) (GROWING DOWN)
        DS   2*26                       ;VARIABLES A..Z
BUFFER: DS   64                         ;INPUT BUFFER
BUFEND: DS   1                          ;BUFFER ENDS
STKLMT: DS   1                          ;BOTTOM LIMIT FOR STACK
STACK:	EQU  RAMBGN+RAMSZE		;STACK AT RAM END
;
